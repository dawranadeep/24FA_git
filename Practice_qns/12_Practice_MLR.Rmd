...
p-value: 3.81e-06 < $\alpha$ = 0.05. So, model is significant.
...
p - value = 0.94198 ; Can not reject $H_0$.
...
p - value = 0.00425 < $\alpha$ ; Reject $H_0$.
...
Model 2: Multiple R-squared:  0.6517, Adjusted R-squared:  0.6259 
...
**Answer:**  All p-values < 0.05. So, polynomial model is fine.
