...
Following are the weight change of 17 horses given an antibiotic for two weeks (in kg):
<center> 2.0, 1.1, 4.4, -3.1, -1.3, 3.9, 3.2, -1.6, 3.5, 1.2, 2.5, 2.3, 1.9, 1.8, 2.9, -0.3, -2.4 </center>
...
- Suppose you believe that UWF students, on average, rate Taylor Swift's songs at least at $80\%$. You collect a random sample of $100$ students to test your hypothesis.
  ...
  * Test statistic: $T = \frac{\sqrt{n}(\bar{x} - 80)}{s}$.
...
The data are the times for seven cockroach eggs to hatch at one laboratory temperature and for eight eggs to hatch at another temperature. I want to test if the average hatching days at $10^{\circ}$C is at least 2 days greater than that at $30^{\circ}$C. Take $\alpha = 0.10$. <br> <br>
...
* $\mu_1$: True population mean at average hatching days at $30^{\circ}$C, $\mu_2 \cdots$ at $10^{\circ}$C. 
...
* **Decision**: Reject since p-value < $\alpha$ or $90\%$ CI does not contain $-2$.
* **Interpretation**: Enough evidence to conclude that average hatching days at $10^{\circ}$C is greater than at least $2$ days.
