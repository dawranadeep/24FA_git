...
Note, in this document, nothing will show when you do $\texttt{?mtcars}$. You should do it in $\texttt{R}$ console to see the output. 
...
Again, you need the summary table. Following table is hosted [here](<>). Keep it open.
