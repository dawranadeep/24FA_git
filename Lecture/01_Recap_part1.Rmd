...
```{r echo=F}
#winglengths <- c(4.3, 4.4, 4.0, 4.5,  3.8, 3.9, 4.1,  3.6, 3.7, 3.3, 3.5, 4.2 )
#mean(winglengths)
```
...
```{r echo =F}
#winglengths <- c(4.3, 4.4, 4.0, 4.5,  3.8, 3.9, 4.1,  3.6, 3.7, 3.3, 3.5, 4.2 )
#median(winglengths) # This is the median
```
...
```{r echo=F}
#winglengths <- c(4.3, 4.4, 4.0, 4.5,  3.8, 3.9, 4.1,  3.6, 3.7, 3.3, 3.5, 4.2 )
#var(winglengths) # This is the variance
#sd(winglengths) #This is the standard deviation
```
